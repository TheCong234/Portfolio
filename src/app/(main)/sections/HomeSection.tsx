      ...
      <div className="relative z-10 transition-all duration-1000 opacity-100">
        <div className="container mx-auto  min-h-screen ">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            <div
              className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0 aos-init aos-animate"
              data-aos="fade-right"
              data-aos-delay="200"
            >
              <div className="space-y-4 sm:space-y-6">
                <div
                  className="inline-block animate-float lg:mx-0 aos-init aos-animate"
                  data-aos="zoom-in"
                  data-aos-delay="400"
                >
                ...
                <div className="space-y-2 aos-init aos-animate" data-aos="fade-up" data-aos-delay="600">
                ...
                <p
                  className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light aos-init aos-animate"
                  data-aos="fade-up"
                  data-aos-delay="1000"
                >
            ...
            <div
              className="w-full py-[10%] sm:py-0 lg:w-1/2 h-auto lg:h-[600px] xl:h-[750px] relative flex items-center justify-center order-2 lg:order-2 mt-8 lg:mt-0 aos-init aos-animate"
              data-aos="fade-left"
              data-aos-delay="600"
            >
